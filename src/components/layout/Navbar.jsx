    ...
    <>
      ...
      <nav
        className={`
          ...
          ${
            scrolled
              ? "bg-white/90 shadow-[0_8px_40px_rgba(11,18,32,0.09)] backdrop-blur-2xl"
              : "bg-white"
          }
        `}
      >
        ...
        <div
          className={`
            ...
            origin-left bg-gradient-to-r from-[#0166FF] via-[#0166FF] to-[#F05C36]
        ...
        <div className="mx-auto max-w-[1450px] px-5 sm:px-8 lg:px-10">
          <div className="flex h-[82px] items-center justify-between">
            ...
            >
              {/* Logo glow */}
              <span className="absolute -inset-3 -z-10 rounded-full bg-[#0166FF]/10 opacity-0 blur-xl transition-all duration-500 group-hover:opacity-100" />
